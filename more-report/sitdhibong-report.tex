...
\begin{table}[ht!]
    ...
    \begin{tabular}{|c|l|} 
        \hline
        $sim_{cosine}(d_1, q)$   & 0.0701  \\
        \hline
        $sim_{cosine}(d_2, q)$   & 0.0773 \\
        \hline
        $sim_{cosine}(d_3, q)$   & 0.0773 \\
        \hline
        $sim_{cosine}(d_4, q)$   & 0.5756 \\
        \hline
    \end{tabular}
\end{table}
...
ในการคำนวณค่าความคล้ายตาม Vector Model เพื่อหาค่า Cosine similarity ดังแสดงในตาราง 
\ref{tab:cosinesimcalulate} นั้นจะได้ค่าความคล้ายกันระหว่างเอกสารและคำค้นออกมา 
เพื่อนำมาใช้จัดเรียงลำดับของเอกสารได้
